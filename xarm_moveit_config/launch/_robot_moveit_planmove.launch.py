...
def launch_setup(context, *args, **kwargs):
    ...
    # robot moveit avoidance launch
    # xarm_moveit_config/launch/_robot_moveit_avoidance.launch.py
    robot_moveit_avoidance_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_moveit_config'), 'launch', '_robot_moveit_avoidance.launch.py'])),
        launch_arguments={
            'prefix': prefix,
            'hw_ns': hw_ns,
            'limited': limited,
